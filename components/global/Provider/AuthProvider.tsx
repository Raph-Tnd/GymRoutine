...
export function AuthProvider({children} : {children : React.ReactElement}){
    ...
    return(
        <AuthContext.Provider value={{currentUser, setCurrentUser, isValidatingUser, setIsValidatingUser}}>
            {(Platform.OS != "ios" && Platform.OS != "android") ?
                <GoogleOAuthProvider clientId="620859170647-2ih3o74dhd7qmhf4vglrh3ag1jse9bk7.apps.googleusercontent.com">{children}</GoogleOAuthProvider>  
                :
                children
            }

...
export function ProgramProvider({children} : {children : React.ReactElement}){
    ...
    return(
        <ProgramContext.Provider value={{currentProgram, setCurrentProgram, currentSessionIndex, setCurrentSessionIndex}}>
            {children}

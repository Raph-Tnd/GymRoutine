...
function TokenToUser(userInfo : JwtPayload) : User{
    let newUser : User = {user: {
        ...
        familyName: "family_name" in userInfo ? userInfo.family_name as string : null,
        givenName: "given_name" in userInfo ? userInfo.given_name as string : null,
...
export function GoogleSignOut({children , style} : {children : React.ReactElement, style : StyleProp<ViewStyle>}){

...
const API_URL = (!process.env.NODE_ENV || process.env.NODE_ENV === 'development') ? "https://mavvin-api-beta-f4702ef3042c.herokuapp.com" : "https://mavvin-api-7f66466edb84.herokuapp.com";
...
export default class APISingleton {
    ...
    public async GetProgramsSaved({user_id} : {user_id : string}) : Promise<ProgramModel[]>{
